...
HD_PWD='C:/Users/Jorge Vasquez/Desktop/ClasesMaestria/CLP/Guia_VHDL/18_Contador_BCD_con_generador_habilitacion/contBCD_gen/contBCD_gen.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Eje18_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Eje18_top.tcl
